...
class StaffNotification extends React.Component {
						...
						<div className="row">
							...
							<div className="col-sm-8">
								<div className="well bg-svg box-shadow m-0">
									<h4 className="header">Notifications
										...
										<div className="well well-lg white-bg">
											<div className="jobs">
												...
												<div className="detail">
													...
													<button className="btn btn-bordered-info">Available</button>
													<button className="btn btn-bordered-danger">Not Available</button>
												</div>
											</div>
										</div>
										<div className="well well-lg white-bg">
...
export default connect(mapStateToProps, mapDispatchToProps)(StaffNotification);